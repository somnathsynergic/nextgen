...
const [isPrinting, setIsPrinting] = useState(true);
  ...
  const iconTemplate = () => {
    return flag == 1 ? (
      ...
      <EditOutlined className={isPrinting?"text-green-900":"hidden"} />
    );
  };
        ...
        {data && (
          <div>
            <div 
             ...
             className={isPrinting?"card w-full mt-5 ":"card w-full mt-5 px-3"}>
              <div className={isPrinting?"hidden w-full":"w-full border border-green-500 rounded-md"}>
              <PrintHeader />
              </div>
              <DataTable
                value={data}
                ...
                styleclassName="p-datatable-gridlines hover:duration-500 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 shadow-lg"
              ...
              >
                {headers.map((item, index) => (
                  <Column
                    ...
                    header={item.value}
                    headerClassName={
                      isPrinting?"text-green-900 bg-[#C4F1BE] border-b-green-900 dark:bg-gray-700 dark:text-white dark:font-bold":"text-white bg-green-500 border-b-green-900 dark:bg-gray-700 dark:text-white dark:font-bold"}
