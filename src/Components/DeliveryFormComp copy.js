...
function DeliveryFormComp({ flag, title, onSubmit }) {
  ...
  const content = (
    <div className="grid grid-cols-2 gap-3 p-3 delay-150 w-full bg-green-100 rounded-lg">
      {!stockLoad ? (
        <>
          {" "}
          <Tag
        ...
        <span className="text-green-900 delay-100 flex gap-2">
          Fetching
        ...
        <div className="grid grid-cols-12 gap-2">
          <div className={"w-full col-span-12 bg-white p-6 rounded-2xl"}>
            <div className="grid gap-4 sm:grid-cols-12 sm:gap-6">
              ...
              >
             <input type="search" id="default-search"  className="bg-gray-200 border-gray-300 border-2 sticky shadow-lg top-1 z-10 rounded-full  text-gray-800 text-sm  my-1 p-2  duration-500 block w-full focus:border-gray-200 focus:ring-gray-200 dark:bg-bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" onChange={(e)=>{setItemFormCopy(itemForm.filter(lst=>lst.name.toLowerCase().includes(e.target.value.toLowerCase())))}} placeholder="Search by items" />
                          ...
                          <tr className="bg-[#DDEAE0] border-b-2 border-white my-3 font-bold dark:bg-gray-800 dark:border-gray-700">
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <DropboxOutlined className="text-lg hover:scale-150 hover:duration-300 hover:text-green-500 " />
                                  <p className="text-xs -ml-1"> Stock </p>
                                </span>
                              </Popover>
                            </th>
                            <th
                            ...
                            {rowSum(
                              ...
                              rowSum(
                               ...
                               <p className="my-2 ">
                               <Tag onClick={e=>e.preventDefault()} color="#92140C"> Pending :  {item.quantity - rowSum(
                                itemList.filter((e) => e.sl_no == item.item_id),
                                item.quantity
                              ).sum 
