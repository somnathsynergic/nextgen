    ...
    <>
      ...
      >
         <div className='mb-2'>
          ...
          <div class="relative">
            <div class={flag == 2 ? "absolute inset-y-0 start-0 flex items-center ps-3  pointer-events-none" : "absolute inset-y-5 start-0 flex items-center ps-3 pointer-events-none"}>
