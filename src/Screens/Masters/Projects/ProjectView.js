...
import CompositeSearchClient from '../../../Components/CompositeSearchClient';
...
const ProjectView = () => {
  ...
  const onAdvSearch = (values)=>{
    console.log(values)
     

     axios.post(url+'/api/advanced_search_client',{client:values.code_two,
      project_manager:values.code_one,
      order_val_to:+values.val_four,
      order_val_from:+values.val_three,
      delivery_dt_from:values.code_five,
      delivery_dt_to:values.code_six,
      order_dt_from:values.code_eight ,
      order_dt_to:values.code_nine 
      }).then(res=>{
        console.log(res)
        setAdvList(res?.data?.msg)
      })

    //advanced_search_client
  }
  return (
    <>
    ...
    <CompositeSearchClient
      data={{
        set_one: pmList,
        set_two: clientList,
        set_one_lbl: "Project Manager",
        set_two_lbl: "Clients",

        set_three: '',
        set_four: '',
        set_three_lbl: "Order value from",
        set_four_lbl: "Order value to",

        set_five: '',
        set_six: '',
        set_five_lbl: "Delivery From",
        set_six_lbl: "Delivery To",
        set_eight_lbl:'Order Date from',
        set_eight:'',
        set_nine_lbl:'Order Date to',
        set_nine:''
      }}
      onReset={() => {
        // setPoData(copy);
...
<DialogBox
        ...
        onVisit={(values)=>navigate(routePaths.ADDPROJECTS+values.sl_no)}
      />
  </>
