    ...
    <section className="bg-transparent dark:bg-[#001529]">
              ...
              >
                ...
                {intended == "C" && (
                  ...
                  >
                    ...
                    <OverlayPanel
                      ref={op}
                      className="w-[23%] border-2 bg-gray-50 border-[#C4F1BE]"
                    >
      ...
      >
        <div className="grid  gap-4 p-4 sm:grid-cols-2 sm:gap-6">
          ...
          <div className="sm:col-span-2 p-2 border border-green-600 rounded-md h-full">
            <h2 className="bg-green-500 font-bold text-lg p-3 text-white">
              Requisition Details
            </h2>
            <table className="border-collapse border border-gray-300 w-full">
              <tbody>
                <tr className="border border-gray-300">
                  ...
                  <td className="border text-gray-600 border-gray-300 p-2">
                    {req_no}
                  </td>
                </tr>
                <tr className="border border-gray-300">
            ...
            <div className="sm:col-span-2 p-2 rounded-md h-full">
              <h2 className="bg-green-500 font-bold text-lg p-3 mt-2 text-white">
                Item Details
              </h2>
