                ...
                <tbody>
                  {po_data &&
                    po_data?.slice(first, rows + first).map((item) => (
                      <tr onClick={()=>{ navigate(routePaths.REQFORM + item.sl_no) }} class="bg-white  cursor-pointer hover:text-green-900 hover:duration-500 hover:bg-gray-200 text-nowrap border-b dark:bg-gray-800 dark:border-gray-700">
                        <th
                          scope="row"
                        ...
                        <td class="px-4 py-4 text-gray-600">{item.req_date}</td>
