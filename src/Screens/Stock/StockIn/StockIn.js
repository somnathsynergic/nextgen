...
import { ArrowUpOutlined, LoadingOutlined, LockFilled, SaveOutlined, SnippetsOutlined } from '@ant-design/icons';
            ...
            {clicked &&
              <SpinComp loading={loading}>
                ...
                <div className="flex justify-center items-center">
                  <BtnGroupReuse loading={loading} onClick={() => onSubmit()} text="Submit" icon={<SaveOutlined className='mr-2' />} disabled={!dt || (!projcode && type != 'W')} flag={1} />
                </div>
              </SpinComp>
            }
            {!clicked &&
